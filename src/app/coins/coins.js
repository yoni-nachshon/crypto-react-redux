                    ...
                    <tr>
                        <th>
                            ...
                            <Button
                                ...
                                onClick={() => sortNumber(["market_data", "market_cap_rank"])}
                            >
                                {sortIcon}
                            </Button>{" "}
                        </th>
                        ...
                        <th>
                            ...
                            <Button
                                ...
                                variant={theme === "dark" ? "dark" : "light"}
                                className={classes.sort}
                                onClick={() => sortNumber(["market_data", "current_price", "usd"])}
                            >
                                {sortIcon}
                            </Button>
                        </th>
                        <th>
                            ...
                            <Button
                                ...
                                variant={theme === "dark" ? "dark" : "light"}
                                className={classes.sort}
                                onClick={() => sortNumber(["market_data", "price_change_percentage_1h_in_currency", "usd"])}
                            >
                                {sortIcon}
                            </Button>
                        </th>
                        <th>
                            ...
                            <Button
                                ...
                                variant={theme === "dark" ? "dark" : "light"}
                                className={classes.sort}
                                onClick={() => sortNumber(["market_data", "price_change_percentage_24h"])}
                            >
                                {sortIcon}
                            </Button>
                        </th>
